...
<h1 className='welcome-message'>Welcome Back</h1>
 ...
 <i className='dashboard-icon'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M13 3a1 1 0 1 0-2 0v.75h-.557A4.214 4.214 0 0 0 6.237 7.7l-.221 3.534a7.377 7.377 0 0 1-1.308 3.754a1.617 1.617 0 0 0 1.135 2.529l3.407.408V19a2.75 2.75 0 1 0 5.5 0v-1.075l3.407-.409a1.617 1.617 0 0 0 1.135-2.528a7.376 7.376 0 0 1-1.308-3.754l-.221-3.533a4.214 4.214 0 0 0-4.206-3.951H13V3Zm-2.25 16a1.25 1.25 0 1 0 2.5 0v-.75h-2.5V19Z" clip-rule="evenodd"/></svg></i>
 <p className='notification'>Notifications</p>
 </div>
 <div className='dashboard-right-side'>
    <div className='patient-dashboard-mini-box'>
        <div className='pd-mini-pic'></div>
        <div className='dashboard-top-bottom'>
        <h5 className='dashboard-text'>Experiencing any Health<br></br>issues lately?</h5>
        <button type='submit' className='patient-dashboard-btn'>Book Appointments</button>
        </div>
    </div>
    ...
    <div className="db-container">
                <div className="db-item">
                    <i className="db-icons"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M8 7a4 4 0 1 1 8 0a4 4 0 0 1-8 0Zm0 6a5 5 0 0 0-5 5a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3a5 5 0 0 0-5-5H8Z" clip-rule="evenodd"/></svg></i>
                    <span className="db-text">
                   <a href=''>0</a>
                    </span>
...
<div className='message-div'>
            ...
            <div className="message-div-image"></div>
        </div>
    </div>
   ...
   <div className="pd-container">
                <div className="pd-item">
                    <i className="pd-icons"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M2.5 5.5v-3h3v3h-3ZM1 2a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2Zm8 .25a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5A.75.75 0 0 1 9 2.25ZM9.75 5a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5h-4.5ZM2.5 10.5v3h3v-3h-3ZM2 9a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1H2Zm7.75.5a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5h-4.5Zm0 3.5a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5h-4.5Z" clip-rule="evenodd"/></svg></i>
            ...
            <div className="pd-container">
                <div className="pd-item">
                    ...
                    <span className="pd-text">
                    <Link to="/appointments"><a href='#'>Appointments</a></Link>
                    </span>
                </div>
            </div>
