...
import FirstPic from "../assets/1.jpeg"
import SecondPic from "../assets/BackgroundImage2.jpeg";
...
<div>
    ...
    <div className='contact-div'>
        <div className='contact-left-side'>
            <h1 className='header'>Reach us on our social<br></br> media platforms</h1>
            <p className='sub-header'>Reach out to us on our socials, engage and get the<br></br> 
            latest on our platform via our socials</p>
            <div className='contact-list'>
            <div className='contact-list-left'>
            <div className='contact-container'>
                <div className='contact-item'>
                    <i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"/></svg></i>
