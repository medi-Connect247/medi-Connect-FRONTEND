      ...
      <div className="contact-section">
        ...
        <div className="contact-right">
          ...
          <p className="contact-sub-text">
            Incase of any further questions or<br></br> inquiries,kindly contact
            us
          </p>
          <form>
            <label>
      ...
      <div className="footer-section">
        <div className="logo-section">
          ...
          <p className="logo-text">
            Gain access to the best telemedicine<br></br> platform, Book
            appointment with medical<br></br> practitioners, and get<br></br>{" "}
