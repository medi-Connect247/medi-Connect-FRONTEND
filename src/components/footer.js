...
function FooterForm() {
  ...
  <div className="entire-footer-div">
  ...
  <p>312, Herbert Macaulay way, Sabo, Yaba</p>
  <p><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M1.946 9.315c-.522-.174-.527-.455.01-.634l19.087-6.362c.529-.176.832.12.684.638l-5.454 19.086c-.15.529-.455.547-.679.045L12 14l6-8l-8 6l-8.054-2.685z"/></svg></i>MediConnect247@gmail.com</p>
  <p><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m19.23 15.26l-2.54-.29a1.99 1.99 0 0 0-1.64.57l-1.84 1.84a15.045 15.045 0 0 1-6.59-6.59l1.85-1.85c.43-.43.64-1.03.57-1.64l-.29-2.52a2.001 2.001 0 0 0-1.99-1.77H5.03c-1.13 0-2.07.94-2 2.07c.53 8.54 7.36 15.36 15.89 15.89c1.13.07 2.07-.87 2.07-2v-1.73c.01-1.01-.75-1.86-1.76-1.98z"/></svg></i>08127117858</p>
  <div className="social-icons">
                <a href="https://facebook.com"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"/></svg></a>
...
<div>
  <h1 className="contact-header">Contact Us</h1>
    <form>
      <label>
        <input type="name" value={name} onChange={handleNameChange} placeholder="Your Name" required />
      </label>
      <label>
        <input type="email" value={email} onChange={handleEmailChange}   placeholder="Your Email" required/>
      </label>
      <label>
        <textarea type="message" value={message} onChange={handleMessageChange}  className="message-form"  placeholder="Message" required/>
      </label>
      {error && <p>{error}</p>}
